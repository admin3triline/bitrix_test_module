...
$aTabs = array(
    array(
        'DIV' => 'edit1',
        'TAB' => Loc::getMessage('TRILINE_TEST_TAB_SETTINGS'),
        'OPTIONS' => array(
            array('field_text', Loc::getMessage('TRILINE_TEST_FIELD_TEXT_TITLE'),
                '',
                array('textarea', 10, 50)),
            array('field_line', Loc::getMessage('TRILINE_TEST_FIELD_LINE_TITLE'),
                '',
                array('text', 10)),
            array('field_list', Loc::getMessage('TRILINE_TEST_FIELD_LIST_TITLE'),
                '',
...
?>
<? $tabControl->Begin(); ?>
<form method='post' action='<?echo $APPLICATION->GetCurPage()?>?mid=<?=htmlspecialcharsbx($request['mid'])?>&amp;lang=<?=$request['lang']?>' name='triline_test_settings'>
